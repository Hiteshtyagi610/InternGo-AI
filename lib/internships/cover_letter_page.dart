...
final String geminiApiKey = 'AIzaSyD3NPxEZggrkI5_HBM1wvHFYmIRNxbstuE';
...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
  ...
  void _sendMessage(BuildContext context, String text) async {
    ...
    String reply = await fetchGeminiResponse(text);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
  children: [
    // Background semi-transparent icon
    Positioned.fill(
      child: IgnorePointer(
        child: Opacity(
          opacity: 0.06,
          child: Center(
            child: Icon(
              Icons.thumb_up_alt_rounded, // or use your logo icon
              size: 280,
              color: Colors.blue.withOpacity(0.6),
            ),
          ),
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              GestureDetector(
                onTap:
                    _loading ? null : () => _sendMessage(context, _controller.text),
                child: AnimatedContainer(
                  duration: Duration(milliseconds: 300),
                  padding: EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: _loading ? Colors.grey :  Colors.blue.withOpacity(0.6),
                    shape: BoxShape.circle,
                    boxShadow: [
                      BoxShadow(
