...
android {
    namespace = "com.interngo.ai" // ⚠️ change to your final package name before publishing
    ...
    defaultConfig {
        applicationId = "com.interngo.ai" // ⚠️ must match Play Store package
    ...
    buildTypes {
        ...
        debug {
            signingConfig = signingConfigs.getByName("release") // optional: sign debug builds with release key
        }
    }
}
